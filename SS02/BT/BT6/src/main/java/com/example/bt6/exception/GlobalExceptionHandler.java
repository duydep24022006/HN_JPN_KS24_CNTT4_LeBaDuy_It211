...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<String> handleWishLimitExceededException(WishLimitExceededException e) {
    ...
    public ResponseEntity<?> handleInvalidWish(
            InvalidWishException e
    ) {
